...
#define EDSDK_API(x)	(WINAPI * x##Pointer)
...
namespace EDSDK {
	...
	------------------------------------------------------------------------*/
	#define EDS_ISSPECIFIC_MASK 0x80000000
	#define EDS_COMPONENTID_MASK 0x7F000000
	#define EDS_RESERVED_MASK 0x00FF0000
	#define EDS_ERRORID_MASK 0x0000FFFF

	/*-----------------------------------------------------------------------
	ED-SDK Base Component IDs
	------------------------------------------------------------------------*/
	#define EDS_CMP_ID_CLIENT_COMPONENTID 0x01000000
	#define EDS_CMP_ID_LLSDK_COMPONENTID 0x02000000
	#define EDS_CMP_ID_HLSDK_COMPONENTID 0x03000000
	...
	#define EDS_ERR_OPERATION_CANCELLED 0x00000005
	#define EDS_ERR_INCOMPATIBLE_VERSION 0x00000006
	#define EDS_ERR_NOT_SUPPORTED 0x00000007
	#define EDS_ERR_UNEXPECTED_EXCEPTION 0x00000008
	#define EDS_ERR_PROTECTION_VIOLATION 0x00000009
	#define EDS_ERR_MISSING_SUBCOMPONENT 0x0000000A
	#define EDS_ERR_SELECTION_UNAVAILABLE 0x0000000B

	/* File errors */
	#define EDS_ERR_FILE_IO_ERROR 0x00000020
	#define EDS_ERR_FILE_TOO_MANY_OPEN 0x00000021
	#define EDS_ERR_FILE_NOT_FOUND 0x00000022
	#define EDS_ERR_FILE_OPEN_ERROR 0x00000023
	#define EDS_ERR_FILE_CLOSE_ERROR 0x00000024
	#define EDS_ERR_FILE_SEEK_ERROR 0x00000025
	#define EDS_ERR_FILE_TELL_ERROR 0x00000026
	#define EDS_ERR_FILE_READ_ERROR 0x00000027
	#define EDS_ERR_FILE_WRITE_ERROR 0x00000028
	#define EDS_ERR_FILE_PERMISSION_ERROR 0x00000029
	#define EDS_ERR_FILE_DISK_FULL_ERROR 0x0000002A
	#define EDS_ERR_FILE_ALREADY_EXISTS 0x0000002B
	#define EDS_ERR_FILE_FORMAT_UNRECOGNIZED 0x0000002C
	#define EDS_ERR_FILE_DATA_CORRUPT 0x0000002D
	#define EDS_ERR_FILE_NAMING_NA 0x0000002E

	/* Directory errors */
	#define EDS_ERR_DIR_NOT_FOUND 0x00000040
	#define EDS_ERR_DIR_IO_ERROR 0x00000041
	#define EDS_ERR_DIR_ENTRY_NOT_FOUND 0x00000042
	#define EDS_ERR_DIR_ENTRY_EXISTS 0x00000043
	#define EDS_ERR_DIR_NOT_EMPTY 0x00000044

	/* Property errors */
	#define EDS_ERR_PROPERTIES_UNAVAILABLE 0x00000050
	#define EDS_ERR_PROPERTIES_MISMATCH 0x00000051
	#define EDS_ERR_PROPERTIES_NOT_LOADED 0x00000053

	/* Function Parameter errors */
	#define EDS_ERR_INVALID_PARAMETER 0x00000060
	#define EDS_ERR_INVALID_HANDLE 0x00000061
	#define EDS_ERR_INVALID_POINTER 0x00000062
	#define EDS_ERR_INVALID_INDEX 0x00000063
	#define EDS_ERR_INVALID_LENGTH 0x00000064
	#define EDS_ERR_INVALID_FN_POINTER 0x00000065
	#define EDS_ERR_INVALID_SORT_FN 0x00000066

	/* Device errors */
	#define EDS_ERR_DEVICE_NOT_FOUND 0x00000080
	#define EDS_ERR_DEVICE_BUSY 0x00000081
	#define EDS_ERR_DEVICE_INVALID 0x00000082
	#define EDS_ERR_DEVICE_EMERGENCY 0x00000083
	#define EDS_ERR_DEVICE_MEMORY_FULL 0x00000084
	#define EDS_ERR_DEVICE_INTERNAL_ERROR 0x00000085
	#define EDS_ERR_DEVICE_INVALID_PARAMETER 0x00000086
	#define EDS_ERR_DEVICE_NO_DISK 0x00000087
	#define EDS_ERR_DEVICE_DISK_ERROR 0x00000088
	#define EDS_ERR_DEVICE_CF_GATE_CHANGED 0x00000089
	#define EDS_ERR_DEVICE_DIAL_CHANGED 0x0000008A
	#define EDS_ERR_DEVICE_NOT_INSTALLED 0x0000008B
	#define EDS_ERR_DEVICE_STAY_AWAKE 0x0000008C
	#define EDS_ERR_DEVICE_NOT_RELEASED 0x0000008D

	/* Stream errors */
	#define EDS_ERR_STREAM_IO_ERROR 0x000000A0
	#define EDS_ERR_STREAM_NOT_OPEN 0x000000A1
	#define EDS_ERR_STREAM_ALREADY_OPEN 0x000000A2
	#define EDS_ERR_STREAM_OPEN_ERROR 0x000000A3
	#define EDS_ERR_STREAM_CLOSE_ERROR 0x000000A4
	#define EDS_ERR_STREAM_SEEK_ERROR 0x000000A5
	#define EDS_ERR_STREAM_TELL_ERROR 0x000000A6
	#define EDS_ERR_STREAM_READ_ERROR 0x000000A7
	#define EDS_ERR_STREAM_WRITE_ERROR 0x000000A8
	#define EDS_ERR_STREAM_PERMISSION_ERROR 0x000000A9
	#define EDS_ERR_STREAM_COULDNT_BEGIN_THREAD 0x000000AA
	#define EDS_ERR_STREAM_BAD_OPTIONS 0x000000AB
	#define EDS_ERR_STREAM_END_OF_STREAM 0x000000AC

	/* Communications errors */
	#define EDS_ERR_COMM_PORT_IS_IN_USE 0x000000C0
	#define EDS_ERR_COMM_DISCONNECTED 0x000000C1
	#define EDS_ERR_COMM_DEVICE_INCOMPATIBLE 0x000000C2
	#define EDS_ERR_COMM_BUFFER_FULL 0x000000C3
	#define EDS_ERR_COMM_USB_BUS_ERR 0x000000C4

	/* Lock/Unlock */
	#define EDS_ERR_USB_DEVICE_LOCK_ERROR 0x000000D0
	#define EDS_ERR_USB_DEVICE_UNLOCK_ERROR 0x000000D1

	/* STI/WIA */
	#define EDS_ERR_STI_UNKNOWN_ERROR 0x000000E0
	#define EDS_ERR_STI_INTERNAL_ERROR 0x000000E1
	#define EDS_ERR_STI_DEVICE_CREATE_ERROR 0x000000E2
	#define EDS_ERR_STI_DEVICE_RELEASE_ERROR 0x000000E3
	#define EDS_ERR_DEVICE_NOT_LAUNCHED 0x000000E4

	#define EDS_ERR_ENUM_NA 0x000000F0
	#define EDS_ERR_INVALID_FN_CALL 0x000000F1
	#define EDS_ERR_HANDLE_NOT_FOUND 0x000000F2
	#define EDS_ERR_INVALID_ID 0x000000F3
	#define EDS_ERR_WAIT_TIMEOUT_ERROR 0x000000F4
	...
	#define EDS_ERR_UNKNOWN_VENDER_CODE 0x00002017
	...
	/* Capture Error */
	#define EDS_ERR_TAKE_PICTURE_AF_NG 0x00008D01
	#define EDS_ERR_TAKE_PICTURE_RESERVED 0x00008D02
	#define EDS_ERR_TAKE_PICTURE_MIRROR_UP_NG 0x00008D03
	#define EDS_ERR_TAKE_PICTURE_SENSOR_CLEANING_NG 0x00008D04
	#define EDS_ERR_TAKE_PICTURE_SILENCE_NG 0x00008D05
	#define EDS_ERR_TAKE_PICTURE_NO_CARD_NG 0x00008D06
	#define EDS_ERR_TAKE_PICTURE_CARD_NG 0x00008D07
	#define EDS_ERR_TAKE_PICTURE_CARD_PROTECT_NG 0x00008D08


	#define EDS_ERR_LAST_GENERIC_ERROR_PLUS_ONE 0x000000F5

	#define CameraCommand_TakePicture 0x00000000
	#define CameraCommand_ExtendShutDownTimer 0x00000001
	#define CameraCommand_BulbStart 0x00000002
	#define CameraCommand_BulbEnd 0x00000003
	#define CameraCommand_DoEvfAf 0x00000102
	#define CameraCommand_DriveLensEvf 0x00000103
	#define CameraCommand_DoClickWBEvf 0x00000104

	#define CameraCommand_PressShutterButton 0x00000004

	#define PropID_Unknown 0x0000ffff

	#define PropID_ProductName 0x00000002
	#define PropID_BodyIDEx 0x00000015
	#define PropID_OwnerName 0x00000004
	#define PropID_MakerName 0x00000005
	#define PropID_DateTime 0x00000006
	#define PropID_FirmwareVersion 0x00000007
	#define PropID_BatteryLevel 0x00000008
	#define PropID_CFn 0x00000009
	#define PropID_SaveTo 0x0000000b
	#define kEdsPropID_CurrentStorage 0x0000000c
	#define kEdsPropID_CurrentFolder 0x0000000d
	#define kEdsPropID_MyMenu 0x0000000e

	#define PropID_BatteryQuality 0x00000010

	#define  PropID_HDDirectoryStructure 0x00000020

	/*----------------------------------
	Image Properties
	----------------------------------*/
	#define PropID_ImageQuality 0x00000100
	#define PropID_JpegQuality 0x00000101
	#define PropID_Orientation 0x00000102
	#define PropID_ICCProfile 0x00000103
	#define PropID_FocusInfo 0x00000104
	#define PropID_DigitalExposure 0x00000105
	#define PropID_WhiteBalance 0x00000106
	#define PropID_ColorTemperature 0x00000107
	#define PropID_WhiteBalanceShift 0x00000108
	#define PropID_Contrast 0x00000109
	#define PropID_ColorSaturation 0x0000010a
	#define PropID_ColorTone 0x0000010b
	#define PropID_Sharpness 0x0000010c
	#define PropID_ColorSpace 0x0000010d
	#define PropID_ToneCurve 0x0000010e
	#define PropID_PhotoEffect 0x0000010f
	#define PropID_FilterEffect 0x00000110
	#define PropID_ToningEffect 0x00000111
	#define PropID_ParameterSet 0x00000112
	#define PropID_ColorMatrix 0x00000113
	#define PropID_PictureStyle 0x00000114
	#define PropID_PictureStyleDesc 0x00000115
	#define PropID_PictureStyleCaption 0x00000200

	/*----------------------------------
	Image Processing Properties
	----------------------------------*/
	#define PropID_Linear 0x00000300
	#define PropID_ClickWBPoint 0x00000301
	#define PropID_WBCoeffs 0x00000302

	/*----------------------------------
	Property Mask
	----------------------------------*/
	#define PropID_AtCapture_Flag 0x80000000

	/*----------------------------------
	Capture Properties
	----------------------------------*/
	#define PropID_AEMode 0x00000400
	#define PropID_AEModeSelect 0x00000436
	#define PropID_DriveMode 0x00000401
	#define PropID_ISOSpeed 0x00000402
	#define PropID_MeteringMode 0x00000403
	#define PropID_AFMode 0x00000404
	#define PropID_Av 0x00000405
	#define PropID_Tv 0x00000406
	#define PropID_ExposureCompensation 0x00000407
	#define PropID_FlashCompensation 0x00000408
	#define PropID_FocalLength 0x00000409
	#define PropID_AvailableShots 0x0000040a
	#define PropID_Bracket 0x0000040b
	#define PropID_WhiteBalanceBracket 0x0000040c
	#define PropID_LensName 0x0000040d
	#define PropID_AEBracket 0x0000040e
	#define PropID_FEBracket 0x0000040f
	#define PropID_ISOBracket 0x00000410
	#define PropID_NoiseReduction 0x00000411
	#define PropID_FlashOn 0x00000412
	#define PropID_RedEye 0x00000413
	#define PropID_FlashMode 0x00000414
	#define PropID_LensStatus 0x00000416

	#define PropID_Artist 0x00000418
	#define PropID_Copyright 0x00000419
	#define PropID_DepthOfField 0x0000041b
	#define PropID_EFCompensation 0x0000041e

	/*----------------------------------
	EVF Properties
	----------------------------------*/
	#define PropID_Evf_OutputDevice 0x00000500
	#define PropID_Evf_Mode 0x00000501
	#define PropID_Evf_WhiteBalance 0x00000502
	#define PropID_Evf_ColorTemperature 0x00000503
	#define PropID_Evf_DepthOfFieldPreview 0x00000504

	// EVF IMAGE DATA Properties
	#define PropID_Evf_Zoom 0x00000507
	#define PropID_Evf_ZoomPosition 0x00000508
	#define PropID_Evf_FocusAid 0x00000509
	#define PropID_Evf_Histogram 0x0000050A
	#define PropID_Evf_ImagePosition 0x0000050B
	#define PropID_Evf_HistogramStatus 0x0000050C
	#define PropID_Evf_AFMode 0x0000050E
	#define PropID_Evf_CoordinateSystem 0x00000540
	#define PropID_Evf_ZoomRect 0x00000541

	#define PropID_Record 0x00000510

	/*----------------------------------
	Image GPS Properties
	----------------------------------*/
	#define PropID_GPSVersionID 0x00000800
	#define PropID_GPSLatitudeRef 0x00000801
	#define PropID_GPSLatitude 0x00000802
	#define PropID_GPSLongitudeRef 0x00000803
	#define PropID_GPSLongitude 0x00000804
	#define PropID_GPSAltitudeRef 0x00000805
	#define PropID_GPSAltitude 0x00000806
	#define PropID_GPSTimeStamp 0x00000807
	#define PropID_GPSSatellites 0x00000808
	#define PropID_GPSStatus 0x00000809
	#define PropID_GPSMapDatum 0x00000812
	#define PropID_GPSDateStamp 0x0000081D
	...
	#define PropertyEvent_All 0x00000100
	...
	#define PropertyEvent_PropertyChanged 0x00000101
	...
	#define PropertyEvent_PropertyDescChanged 0x00000102

	/*----------------------------------
	Object Event
	----------------------------------*/
	/* Notifies all object events. */
	#define ObjectEvent_All 0x00000200
	...
	#define ObjectEvent_VolumeInfoChanged 0x00000201
	...
	#define ObjectEvent_VolumeUpdateItems 0x00000202
	...
	from event data. */
	#define ObjectEvent_FolderUpdateItems 0x00000203
	...
	#define ObjectEvent_DirItemCreated 0x00000204
	...
	#define ObjectEvent_DirItemRemoved 0x00000205
	...
	Notification of this event is not issued for type 1 protocol standard cameras. */
	#define ObjectEvent_DirItemInfoChanged 0x00000206
	...
	#define ObjectEvent_DirItemContentChanged 0x00000207
	...
	#define ObjectEvent_DirItemRequestTransfer 0x00000208
	...
	execute EdsDownloadCancel and release resources held by the camera.
	Notification of this event is not issued for type 1 protocol standard cameras. */
	#define ObjectEvent_DirItemRequestTransferDT 0x00000209
	...
	Notification of this event is not issued for type 1 protocol standard cameras. */
	#define ObjectEvent_DirItemCancelTransferDT 0x0000020a

	#define ObjectEvent_VolumeAdded 0x0000020c
	#define ObjectEvent_VolumeRemoved 0x0000020d

	/*----------------------------------
	State Event
	----------------------------------*/
	/* Notifies all state events. */
	#define StateEvent_All 0x00000300
	...
	#define StateEvent_Shutdown 0x00000301
	...
	standard cameras. */
	#define StateEvent_JobStatusChanged 0x00000302
	...
	#define StateEvent_WillSoonShutDown 0x00000303
	...
	#define StateEvent_ShutDownTimerUpdate 0x00000304

	/* Notifies that a requested release has failed, due to focus
	failure or similar factors. */
	#define StateEvent_CaptureError 0x00000305
	...
	#define StateEvent_InternalError 0x00000306

	#define StateEvent_AfResult 0x00000309


	#define StateEvent_BulbExposureTime 0x00000310

	enum class EdsDataType {
		Unknown = 0,
		Bool = 1,
		String = 2,
		Int8 = 3,
	...
	struct EdsVolumeInfo {
		...
		CHAR   szVolumeLabel[EDS_MAX_NAME];
	};
	...
	struct EdsSaveImageSetting {
		DWORD     JPEGQuality;
		LPVOID    iccProfileStream;
		DWORD     reserved;
	};
	...
	struct EdsImageInfo {
		...
		DWORD NumOfComponents;        // number of color components in image.
		DWORD ComponentDepth;         // bits per sample.  8 or 16.
	...
	typedef DWORD EDSDK_API(EdsInitializeSDK)();
	...
	typedef DWORD EDSDK_API(EdsTerminateSDK)();
	...
	typedef DWORD EDSDK_API(EdsRetain)(IN LPVOID inRef);
	...
	typedef DWORD EDSDK_API(EdsRelease)(IN LPVOID inRef);
	...
	typedef DWORD EDSDK_API(EdsGetChildCount)(IN LPVOID inRef, OUT LPINT outCount);
	...
	typedef DWORD EDSDK_API(EdsGetChildAtIndex)(IN LPVOID inRef, IN INT inIndex, OUT LPVOID *outRef);
	...
	typedef DWORD EDSDK_API(EdsGetParent)(IN LPVOID inRef, OUT LPVOID *outParentRef);
	...
	typedef DWORD EDSDK_API(EdsGetPropertySize)(IN LPVOID inRef, IN DWORD inPropertyID, IN INT inParam,
		OUT LPDWORD outDataType, OUT LPINT outSize);
	...
	typedef DWORD EDSDK_API(EdsGetPropertyData)(IN LPVOID inRef, IN DWORD inPropertyID, IN INT inParam,
		IN INT inPropertySize, OUT LPVOID outPropertyData);
	...
	typedef DWORD EDSDK_API(EdsSetPropertyData)(IN LPVOID inRef, IN DWORD inPropertyID,
		IN INT inParam, IN INT inPropertySize, IN LPVOID inPropertyData);
	...
	typedef DWORD EDSDK_API(EdsGetPropertyDesc)(IN LPVOID inRef, IN DWORD inPropertyID,
	...
	typedef DWORD EDSDK_API(EdsGetCameraList)(OUT LPVOID *outCameraListRef);
	...
	typedef DWORD EDSDK_API(EdsGetDeviceInfo)(IN LPVOID inCameraRef, OUT EdsDeviceInfo *outDeviceInfo);
	...
	typedef DWORD EDSDK_API(EdsOpenSession)(IN LPVOID inCameraRef);
	...
	typedef DWORD EDSDK_API(EdsCloseSession)(IN LPVOID inCameraRef);
	...
	typedef DWORD EDSDK_API(EdsSendCommand)(IN LPVOID inCameraRef, IN DWORD inCommand, IN DWORD inParam);
	...
	typedef DWORD EDSDK_API(EdsSendStatusCommand)(IN LPVOID inCameraRef, IN DWORD inCameraState, IN int inParam);
	...
	typedef DWORD EDSDK_API(EdsSetCapacity)(LPVOID inCameraRef, IN EdsCapacity inCapacity);
	...
	typedef DWORD EDSDK_API(EdsGetVolumeInfo)(IN LPVOID inCameraRef, OUT EdsVolumeInfo *outVolumeInfo);
	...
	typedef DWORD EDSDK_API(EdsFormatVolume)(IN LPVOID inVolumeRef);
	...
	typedef DWORD EDSDK_API(EdsGetDirectoryItemInfo)(IN LPVOID inDirItemRef,
	...
	typedef DWORD EDSDK_API(EdsDeleteDirectoryItem)(IN LPVOID inDirItemRef);
	...
	typedef DWORD EDSDK_API(EdsDownload)(IN LPVOID inDirItemRef, IN DWORD inReadSize, IN LPVOID outStream);
	...
	typedef DWORD EDSDK_API(EdsDownloadCancel)(IN LPVOID inDirItemRef);
	...
	typedef DWORD EDSDK_API(EdsDownloadComplete)(IN LPVOID inDirItemRef);
	...
	typedef DWORD EDSDK_API(EdsDownloadThumbnail)(IN LPVOID inDirItemRef, IN LPVOID outStream);
	...
	typedef DWORD EDSDK_API(EdsGetAttribute)(IN LPVOID inDirItemRef, OUT LPDWORD outFileAttribute);
	...
	typedef DWORD EDSDK_API(EdsSetAttribute)(LPVOID inDirItemRef, IN DWORD inFileAttribute);
	...
	typedef DWORD EDSDK_API(EdsCreateFileStream)(IN LPSTR inFileName, IN DWORD inCreateDisposition,
		IN DWORD inDesiredAccess, OUT LPVOID *outStream);
	...
	typedef DWORD EDSDK_API(EdsCreateMemoryStream)(IN DWORD inBufferSize, OUT LPVOID *outStream);
	...
	typedef DWORD EDSDK_API(EdsCreateStreamEx)(
		IN LPSTR inFileName,
		IN DWORD inCreateDisposition,
		IN DWORD inDesiredAccess,
		OUT LPVOID *outStream
	);
	...
	typedef DWORD EDSDK_API(EdsCreateMemoryStreamFromPointer)(IN LPVOID inUserBuffer,
		IN DWORD inBufferSize, OUT LPVOID *outStream);
	...
	typedef DWORD EDSDK_API(EdsGetPointer)(IN LPVOID inStreamRef, OUT LPVOID *outPointer);
	...
	typedef DWORD EDSDK_API(EdsRead)(IN LPVOID inStreamRef, IN DWORD inReadSize, OUT LPVOID outBuffer,
		OUT DWORD *outReadSize);
	...
	typedef DWORD EDSDK_API(EdsWrite)(IN LPVOID inStreamRef, IN DWORD inWriteSize, IN LPVOID inBuffer,
		OUT DWORD *outWrittenSize);
	...
	typedef DWORD EDSDK_API(EdsSeek)(IN LPVOID inStreamRef, IN INT inSeekOffset, 
		IN DWORD inSeekOrigin);
	...
	typedef DWORD EDSDK_API(EdsGetPosition)(
		IN LPVOID inStreamRef, OUT DWORD *outPosition);
	...
	typedef DWORD EDSDK_API(EdsGetLength)(IN LPVOID inStreamRef, OUT DWORD *outLength);
	...
	typedef DWORD EDSDK_API(EdsCopyData)(IN LPVOID inStreamRef, IN DWORD inWriteSize, OUT LPVOID outStreamRef);
	...
	typedef DWORD(WINAPI *ProgressCallbackEventPtr)(DWORD inPercent, LPVOID inContext, bool &outCancel);
	typedef DWORD EDSDK_API(EdsSetProgressCallback)(IN LPVOID inRef, IN ProgressCallbackEventPtr inProgressFunc,
		IN DWORD inProgressOption, IN LPVOID inContext);
	...
	typedef DWORD EDSDK_API(EdsCreateImageRef)(LPVOID inStreamRef, OUT LPVOID *outImageRef);
	...
	typedef DWORD EDSDK_API(EdsGetImageInfo)(IN LPVOID inImageRef, IN DWORD inImageSource,
	...
	typedef DWORD EDSDK_API(EdsGetImage)(IN LPVOID inImageRef, IN DWORD inImageSource,
		IN DWORD inImageType, IN EdsRect *inSrcRect, IN EdsSize *inDstSize, OUT LPVOID *outStreamRef);
	...
	typedef DWORD EDSDK_API(EdsSaveImage)(IN LPVOID inImageRef, IN DWORD inImageType,
		IN EdsSaveImageSetting *inSaveSetting, OUT LPVOID *outStreamRef);
	...
	typedef DWORD EDSDK_API(EdsCacheImage)(IN LPVOID inImageRef, IN bool inUseCache);
	...
	typedef DWORD EDSDK_API(EdsReflectImageProperty)(IN LPVOID inImageRef);
	...
	typedef DWORD EDSDK_API(EdsSetCameraAddedHandler)(IN FARPROC inCameraAddedHandler,
		IN LPVOID inContext);
	...
	typedef DWORD(WINAPI *PropertyEventPtr)(DWORD inEvent, DWORD inPropertyID, DWORD inParameter, LPVOID inContext);
	typedef DWORD EDSDK_API(EdsSetPropertyEventHandler)(IN LPVOID inCameraRef, IN DWORD inEvnet,
		IN PropertyEventPtr inPropertyEventHandler, IN LPVOID inContext);
	...
	typedef DWORD(WINAPI *ObjectEventPtr)(DWORD inEvent, LPVOID inRef, LPVOID inContext);
	typedef DWORD EDSDK_API(EdsSetObjectEventHandler)(IN LPVOID inCameraRef, IN DWORD inEvnet,
		IN ObjectEventPtr inObjectEventHandler, IN LPVOID inContext);
	...
	typedef DWORD(WINAPI *StateEventPtr)(DWORD inEvent, DWORD inParameter, LPVOID inContext);
	typedef DWORD EDSDK_API(EdsSetCameraStateEventHandler)(IN LPVOID inCameraRef, IN DWORD inEvnet,
		IN StateEventPtr inStateEventHandler, IN LPVOID inContext);
	...
	typedef DWORD EDSDK_API(EdsCreateEvfImageRef)(IN LPVOID inStreamRef, OUT LPVOID *outEvfImageRef);
	...
	typedef DWORD EDSDK_API(EdsDownloadEvfImage)(IN LPVOID inCameraRef, IN LPVOID inEvfImageRef);
	...
	typedef DWORD EDSDK_API(EdsGetEvent)();
